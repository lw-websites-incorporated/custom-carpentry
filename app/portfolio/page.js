      ...
      <section ref={sectionRef} className="section-padding bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {siteConfig.portfolio.categories.map((category, index) => (
              ...
              >
                ...
                {/* Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#1E1E1E]/90 via-[#1E1E1E]/40 to-transparent group-hover:from-[#089DC0]/90 group-hover:via-[#089DC0]/50 transition-all duration-300" />
          ...
          <div className={`text-center mt-12 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-[#089DC0] text-white px-8 py-4 rounded font-medium hover:bg-[#067a99] transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              Start Your Project
