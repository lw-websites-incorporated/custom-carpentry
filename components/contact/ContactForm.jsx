...
export default function ContactForm() {
  ...
  if (isSubmitted) {
    return (
      <div className="bg-white rounded-lg p-8 shadow-lg text-center">
        ...
        <h3 className="text-2xl font-playfair font-bold text-[#2D2D2D] mb-2">
          Thank You!
        </h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-lg p-8 shadow-lg">
      <h3 className="text-2xl font-playfair font-bold text-[#2D2D2D] mb-6">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B8860B] transition-all ${
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B8860B] transition-all"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B8860B] transition-all bg-white"
          >
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B8860B] transition-all resize-none ${
        ...
        <button
          ...
          className="w-full bg-[#B8860B] text-white py-4 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-[#9a7209] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
            <>
